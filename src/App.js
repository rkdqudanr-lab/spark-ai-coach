...
function App() {
  ...
  // 채팅 화면
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-100 via-rose-100 to-pink-100 flex flex-col">
      {/* 헤더 - 상단 고정 */}
      <div className="sticky top-0 z-10 bg-white/90 backdrop-blur-xl border-b border-orange-200 shadow-lg">
